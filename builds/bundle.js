...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Menu = __webpack_require__(/*! ./javascripts/Menu.js */ 160);
	
	var _Menu2 = _interopRequireDefault(_Menu);
	
	var _Chat = __webpack_require__(/*! ./javascripts/Chat.js */ 161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Menu = _react2.default.createClass({
		...
		render: function render() {
			...
			var pages = this.props.list.map(function (item, i) {
				return _react2.default.createElement(MenuItem, { key: 'page' + i, active: state.active_tab === i ? 'true' : 'false', icon: item.icon, pageName: item.page_name, onClick: that.clickHandler.bind(that, i) });
			});
	...
	var MenuItem = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				'button',
				{ className: this.props.active === 'false' ? 'nav-item' : 'nav-item selected', 'data-active': this.props.active, onClick: this.props.onClick },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _socket = __webpack_require__(/*! socket.io-client */ 162);
	...
	var ChatMsg = _react2.default.createClass({
	   ...
	   render: function render() {
	      return _react2.default.createElement(
	         'li',
	         { className: this.props.user === 'chris' ? 'chat-msg text-right' : 'chat-msg' },
	...
	var ChatMessages = _react2.default.createClass({
	   ...
	   render: function render() {
	      return _react2.default.createElement(
	         ...
	         this.props.messages.map(function (msg, index) {
	            ...
	            return _react2.default.createElement(ChatMsg, { key: index, user: msg.user, message: msg.message });
	         })
	      );
	   }
	});
	...
	var ChatForm = _react2.default.createClass({
	   ...
	   render: function render() {
	      return _react2.default.createElement(
	         ...
	         _react2.default.createElement('input', { id: 'm', ref: 'msg', autoComplete: 'off', value: this.state.text, onChange: this.update }),
	         _react2.default.createElement(
	            'button',
	            { className: 'chat-submit', type: 'submit' },
	            'Send'
	         )
	      );
	   }
	...
	var socket = _socket2.default.connect('http://185.13.90.140:8081');
